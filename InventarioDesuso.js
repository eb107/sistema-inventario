...
function fetchInventarioDesuso() {
    fetch('http://localhost:3000/api/somadesuso')
        .then(response => {
            if (!response.ok) {
        ...
        .then(data => {
            ...
            titulo.textContent = 'Equipamentos sem utilização'
...
document.addEventListener('DOMContentLoaded', fetchInventarioDesuso);